...
vardescription <- function(var) {
  ...
  multiobs_line = ifelse(var$MultiObs == 1, "{{var$NUnits}} individuals with between {{var$MinObsPerUnit}} and {{var$MaxObsPerUnit}} observations each\\\n", NA)
...
source <- function(src) {
  ...
  plural_level <- ifelse(src$MeasurementLevel == 'Mother', 'mothers',
                         ifelse(src$MeasurementLevel == 'Child', 'children',
                                ifelse(src$MeasurementLevel == 'Father', 'fathers',
                                       ifelse(src$MeasurementLevel == 'Pregnancy', 'pregnancies'))))

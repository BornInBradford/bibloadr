...
meta <- get_bibloadr_meta(varfile = varfile, varlist = varlist, type = "varsection")
sourcemeta <- get_bibloadr_meta(varfile = varfile, varlist = varlist, type = "sourcelong")
codebook <- get_bibloadr_meta(varfile = varfile, varlist = varlist, type = "code")
stats <- get_bibloadr_stats(varfile = varfile, varlist = varlist)

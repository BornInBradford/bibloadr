...
meta <- get_bibloadr_meta(varfile = varfile, varlist = varlist, srclist = srclist, type = "varsection")
sourcemeta <- get_bibloadr_meta(varfile = varfile, varlist = varlist, srclist = srclist, type = "sourcelong")
codebook <- get_bibloadr_meta(varfile = varfile, varlist = varlist, srclist = srclist, type = "code")
stats <- get_bibloadr_stats(varfile = varfile, varlist = varlist, srclist = srclist)
